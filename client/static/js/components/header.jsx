								...
								<div className="row">
									...
									<div className="col-xs-6 col-sm-6">
										<div className="form-group search-bar-size">
											<input defaultValue="spotify:user:1212962782:playlist:2sHMFrnmCWFUlRYNRpq8Qq" type="text" className="form-control" ref="search_in" id="search_in" placeholder={ this.props.placeholder }/>
										</div>
									</div>
									<div className="col-xs-3 col-sm-3">
										<div className="form-group search-bar-size">
